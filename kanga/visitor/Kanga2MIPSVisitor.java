...
public class Kanga2MIPSVisitor extends GJDepthFirst<String, Method> {
	...
	public String visit(NodeOptional n, Method argu) {
		...
		if ( n.present() ) // print label
			Context.out.print(n.node.accept(this, argu) + ":");
		return null;
	}
	...
	public String visit(Goal n, Method argu) {
		...
		Context.out.println("\t.globl " + currMethod.methodName);
		Context.out.println(currMethod.methodName + ":");
		// new frame
		Context.out.println("\tsw $fp, -8($sp)");
		Context.out.println("\tsw $ra, -4($sp)");
		Context.out.println("\tmove $fp, $sp");
		Context.out.println("\tsubu $sp, $sp, " + 4*currMethod.stackNum);

		n.f10.accept(this, currMethod);//inside main
		n.f11.accept(this, currMethod);//inside main

		// recover frame
		Context.out.println("\tlw $ra, -4($fp)");
		Context.out.println("\tlw $fp, -8($fp)");
		Context.out.println("\taddu $sp, $sp, " + 4*currMethod.stackNum);
		Context.out.println("\tj $ra");
		Context.out.println();
		...
		// _halloc:
		Context.out.println("\t.text");
		Context.out.println("\t.globl _halloc");
		Context.out.println("_halloc:");
		Context.out.println("\tli $v0, 9");
		Context.out.println("\tsyscall");
		Context.out.println("\tj $ra");
		Context.out.println();
		// _print:
		Context.out.println("\t.text");
		Context.out.println("\t.globl _print");
		Context.out.println("_print:");// _print:
		Context.out.println("\tli $v0, 1");
		Context.out.println("\tsyscall");
		Context.out.println("\tla $a0, newl");
		Context.out.println("\tli $v0, 4");
		Context.out.println("\tsyscall");
		Context.out.println("\tj $ra");
		Context.out.println();
		// newl:
		Context.out.println("\t.data");
		Context.out.println("\t.align 0");
		Context.out.println("newl:");// newl:
		Context.out.println("\t.asciiz \"\\n\"");
		// str_er:
		Context.out.println("\t.data");
		Context.out.println("\t.align 0");
		Context.out.println("str_er:");// str_er:
		Context.out.println("\t.asciiz \" ERROR: abnormal termination\\n\"");
	...
	public String visit(CJumpStmt n, Method argu) {
		...
		Context.out.println("\tbeqz $" + n.f1.accept(this, argu) + ", "
	...
	public String visit(JumpStmt n, Method argu) {
		...
		Context.out.println("\tb " + n.f1.accept(this, argu));
		return _ret;
	}
	...
	public String visit(HStoreStmt n, Method argu) {
		...
		Context.out.println("\tsw $" + n.f3.accept(this, argu) + ", " //regFrom
			+ n.f2.accept(this, argu) //offset
			+ "($" + n.f1.accept(this, argu) + ")");//regTo
		return _ret;
	}
	...
	public String visit(HLoadStmt n, Method argu) {
		...
		Context.out.println("\tlw $" + n.f1.accept(this, argu) + ", "//regTo
			+ n.f3.accept(this, argu) //offset
			+ "($" + n.f2.accept(this, argu) + ")"); //regFrom
		return _ret;
	}
	...
	public String visit(MoveStmt n, Method argu) {
		...
		Context.out.println("\tmove $" + n.f1.accept(this, argu)//regTo
			+ ", $" + n.f2.accept(this, argu));//regFrom
		return _ret;
	}
	...
	public String visit(PrintStmt n, Method argu) {
		...
		Context.out.println("\tmove $a0, $" + n.f1.accept(this, argu));
		Context.out.println("\tjal _print");
		return _ret;
	}
	...
	public String visit(AStoreStmt n, Method argu) {
		...
		Context.out.println("\tsw $" + n.f2.accept(this, argu) + ", "//regFrom
			+ n.f1.accept(this, argu));//spilled
		return _ret;
	}
	...
	public String visit(CallStmt n, Method argu) {
		...
		Context.out.println("\tjalr $" + n.f1.accept(this, argu));
		return _ret;
	}
	...
	public String visit(HAllocate n, Method argu) {
		...
		Context.out.println("\tmove $a0, $" + n.f1.accept(this, argu));//it's a register
		Context.out.println("\tjal _halloc");
		return "v0";
	}
	...
	public String visit(BinOp n, Method argu) {
		...
		Context.out.println("\t" + n.f0.accept(this, argu)//operator
	...
	public String visit(SimpleExp n, Method argu) {
		...
		if (n.f0.which == 0) {
			...
			_ret = "v1";
			if (n.f0.which == 1) {
				Context.out.println("\tli $v1, " + simpleExp);
			} else {
				Context.out.println("\tla $v1, " + simpleExp);
			}
		}
		return _ret;
	}
